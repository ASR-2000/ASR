...
<table>
<tr>
<td><img src="" alt="INFERNO" class="logo"></td>
<td>
...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content cart-content">
      ...
      <span class="sub-title"><i class="fa PKR"></i>5999<span>
      </li>
    ...
    <div class="slideshow-items">
      <div class="item">
        <div class="item-image-container">
          <img class="item-image" src="https://i.ibb.co/d7Rn88d/slide1.jpg" />
        </div>
        <!-- Staggered Header Elements -->
        <div class="item-header">
          <span class="vertical-part"><b>Striking Deals On <em>Men's FootWare</em></em></b></span>
        </div>
      ...
      <div class="item">
        <div class="item-image-container">
          <img class="item-image" src="https://i.ibb.co/fQrPPpR/slide2.jpg" />
        </div>
        <!-- Staggered Header Elements -->
        <div class="item-header">
        ...
        <div class="item-description">
          <span class="vertical-part desc">
            <b>Upto 10% off on cart value more than <i class="fa PKR"></i>5000</b>
          </span>
        </div>
      </div>
      <div class="item">
        <div class="item-image-container">
          <img class="item-image" src="https://i.ibb.co/GJ9C3kV/slide3.jpg" />
        </div>
        <!-- Staggered Header Elements -->
        <div class="item-header">
          <span class="vertical-part" style="color:#fff;"><b>ShopNow On <em>INFERNO</em></b></span>
        </div>
        <!-- Staggered Description Elements -->
        <div class="item-description">
...
<span class="title">Samsung Galaxy POP</span>
<span class="sub-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span>
<a href="#" class="btn1"><i class="fa PKR"></i> 5999</a>
</div>
...
<span class="btn1"><i class="fa PKR"></i>9999</span> <strike><i class="fa PKR"></i>10200</strike>
</div>
